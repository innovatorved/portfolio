...
Check the [README](https://github.com/innovatorved/realtime-interview-copilot/tree/desktop-app) for detailed setup instructions.
...
- **GitHub**: [Desktop App Branch](https://github.com/innovatorved/realtime-interview-copilot/tree/desktop-app)
